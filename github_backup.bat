...
rm -rf fine_tuned_bert_model

# Reinitialize with proper structure
python -c "
from transformers import BertModel, BertTokenizer; 
BertModel.from_pretrained('bert-base-uncased').save_pretrained('fine_tuned_bert_model');
BertTokenizer.from_pretrained('bert-base-uncased').save_pretrained('fine_tuned_bert_model')
"
